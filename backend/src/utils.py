...
from src.discovery.splitminer.split_miner import discover_petri_net_split
from src.discovery.structuredminer.fodina_miner import discover_petri_net_fodina


def generate_log_id(log_path):
    return filehelper.split_file_path(log_path)["filename"]
...
if __name__ == "__main__":
    log_paths = filehelper.gather_all_xes("../logs/logs_in_xes")
    for log_path in log_paths:
        log = read_log(log_path)
